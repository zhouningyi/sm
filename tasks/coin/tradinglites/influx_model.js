...
const depth1m = require('./schema/depth1m.json');
const kline1m = require('./schema/kline1m.json');
const trade1m = require('./schema/trade1m.json');
...
const schemaMap = { depth1m, kline1m, trade1m, trade };
...
class Model {
  ...
  async batchUpsert(ds, o = {}) {
    await this.batchInsert(ds, o = {});
  }
