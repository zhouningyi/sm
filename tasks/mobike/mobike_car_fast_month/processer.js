...
const historyUpsert = (datas) => {
  ...
  return `
  INSERT INTO public.mobike_car_fast_month_histories ( unique_id, car_id, time, lat, lng, center, bike_type, distance, "createdAt", "updatedAt" )
  VALUES ${values.join(',')}
  ...
  "createdAt" = public.mobike_car_fast_month_histories."createdAt", "updatedAt" = EXCLUDED."updatedAt";
  `;
}
...
const carUpsert = (datas) => {
  ...
  return `
  INSERT INTO public.mobike_car_fast_months ( car_id, bike_type, lat, lng, distance, hongbao_type, district_adcode, center, "createdAt", "updatedAt" )
  VALUES ${values.join(',')}
  ...
  "createdAt" = public.mobike_car_fast_months."createdAt", "updatedAt" = EXCLUDED."updatedAt";
  `;
}
