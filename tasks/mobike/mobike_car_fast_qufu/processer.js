...
* @Last modified time: 2017-05-26T14:42:01+08:00
*/
...
const historyUpsert = (datas) => {
  ...
  return `
  INSERT INTO public.mobike_car_fast_new_histories ( unique_id, car_id, time, lat, lng, center, bike_type, distance, "createdAt", "updatedAt" )
  VALUES ${values.join(',')}
  ...
  "createdAt" = public.mobike_car_fast_new_histories."createdAt", "updatedAt" = EXCLUDED."updatedAt";
  `;
}
...
const carUpsert = (datas) => {
  ...
  return `
  INSERT INTO public.mobike_car_fast_news ( car_id, bike_type, lat, lng, distance, hongbao_type, district_adcode, center, "createdAt", "updatedAt" )
  VALUES ${values.join(',')}
  ...
  "createdAt" = public.mobike_car_fast_news."createdAt", "updatedAt" = EXCLUDED."updatedAt";
  `;
}
